...
export function MapObjectListItem({ map, obj, index }: MapObjectListItemProps): JSX.Element {
    ...
    function trashObject(random_id: string, index: number): void {
    ...
    function getBackgroundColor(obj: MapObject): `#${string}` {
        switch (obj.data.item.type) {
            ...
            case MapObjectType.FLOR:
                return "#ebfbee"
            case MapObjectType.WALL: return "#fff5f5"
            case MapObjectType.CHAR: return "#fff9db"
            case MapObjectType.DOOR: return "#f8f9fa"
            case MapObjectType.ITEM: return "#f3f0ff"
            case MapObjectType.WATER: return "#e7f5ff"
    ...
    return (
        ...
        >
            <Group>
                ...
                <ActionIcon
                    color={"red"}
                    onClick={() => trashObject(obj.random_id, index)}>
                    <IconTrash />
                </ActionIcon>
            </Group>
        </Card>
