            ...
            <v-col cols="12" md="6">
                <v-card style="padding: 1rem;">
                    ...
                    <div style="padding-top: 1rem;">
                        <v-select label="Select Episode" :items="episodeSelections"></v-select>
                    </div>
                </v-card>
            </v-col>
            <v-col cols="12" md="6">
                <v-card style="padding: 1rem;" variant="tonal">
                    ...
                    <v-card-subtitle>
                        ...
                        Project File (.ccsr.zip)
                    </v-card-subtitle>
                    <v-file-input label="Select Project File" variant="underlined" :prepend-icon="'mdi-upload'"
                        accept=".ccsr.zip" append-inner-icon="mdi-folder-zip"></v-file-input>
                </v-card>
            </v-col>
        </v-row>
    </v-container>
